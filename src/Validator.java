...
public class Validator {
	...
	public static String getStringJS(Scanner sc, String prompt) {
		String s = null;
		...
		while (isValid == false) {
			...
			if (sc.hasNext()) {
				s = sc.next();
				sc.nextLine(); // discard any other data entered on the line
				if (s.length() == 1 && s.equalsIgnoreCase("j") || s.equalsIgnoreCase("s")) {
					isValid = true;
				} else {
					System.out.println("Error! Invalid answer. Please enter 'j' or 's'.");
				}
	...
	public static String getStringRPS(Scanner sc, String prompt) {
		String s = null;
		...
		while (isValid == false) {
			...
			if (sc.hasNext()) {
				s = sc.next();
				sc.nextLine(); // discard any other data entered on the line
				if (s.length() == 1 && s.equalsIgnoreCase("r") || s.equalsIgnoreCase("p") || s.equalsIgnoreCase("s")) {
					isValid = true;
				} else {
					System.out.println("Error! Invalid answer. Please enter 'r' or 'p' or 's'.");
				}
